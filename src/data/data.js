const data = {
    ...
    article: {
        ...
        personaBody2: "The persona uses an archetype (the explorer), which helps it resonate with people across cultures and time periods, making it universal.",
        ...
        taxonomyBody: "The next and final step was to redesign the categories of the website. This should be done because the research showed that the current categories are confusing and articles are placed in categories that do not make sense for users.",
        ...
        conclusionBody2: "This project highlights the importance of balancing user-centered design principles with business goals and leaves me optimistic about the outcomes it will deliver when implemented.",
    ...
    onboarding: {
        ...
        notificationsBody: "Before working on the onboarding, I designed the component that will trigger the flow. Similar to a notification, the trigger will appear at the top right of the screen on desktop, and as a toast notification on mobile.",
        ...
        questionnaireBody4: "The helpful content section presents an overview of all available countries and disciplines, with a short description. The cards are clickable, allowing users to easily select the ones they find relevant.",
        ...
        testingBody: "After finishing the first iteration, I built a desktop prototype that I could test with users.",
        testingBody2: "The prototype was tested with five users. The results were mostly positive, but we still found some usability issues and areas for improvement.",
