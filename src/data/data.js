const data = {
    ...
    cid: {
        ...
        challengeBody: "The Central Innovation District is the economic centre of the Hague. The municipality is actively engaging future residents, entrepreneurs, and organizations to shape the neighborhood's transformation.",
        ...
        discoveryTitleBody: "In our research, we focused on understanding the youth's perception of the CID, their communication preferences regarding government information, and their motivation for visiting public information centers.",
        discoveryTitleBody2: "Our goal was to create a space that could engage the youth and skilled migrants because these were the audiences that the municipality had difficulties reaching.",
        ...
        personaBody2: "This ensures that we design a space that is inclusive and that can engage both audiences.",
        ...
        conceptBody2: "The space is modular, and enables the community to use it according to their needs. It can be used both as a regular information space, but also as a space that hosts community events.",
        conceptBody3: "We use the marketing flywheel to ensure that the space is self-sustainable and that it can grow organically. We attract our target audience using cultural events, and incentivize them to participate in co-creation sessions.",
        ...
        userJourneyColor: "var(--tertiary-yellow)",
        touchPointsTitle: "Touch Points",
        touchPointsColor: "var(--secondary-blue)",
        touchPointsBody: "Next, we designed all touch points that visitors can interact with within the space. Each serves a specific purpose and is designed to facilitate the user's journey.",
        touchPointsBody2: "All touchpoints went through multiple iterations and were tested with real users. For the purpose of this case study, I will only present the final designs.",
    },
    ...
    ai: {
        ...
        discoveryTitleBody5: "By leveraging AI-generated personas, we could simulate a variety of visitor behaviors and responses, which was valuable for ideation and solution development.",
    },
