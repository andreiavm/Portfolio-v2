const data = {
    ...
    onboarding: {
        ...
        challengeBody3: "User registration is also a goal but is not the primary focus. The main objective is to complete the flow and choose to create an account based on a clear understanding of the value it offers.",
        challengeBody4: "Finally, the onboarding should be context-sensitive, and it should trigger only on pages where users are more likely to interact with it without feeling annoyed.",
        ideationTitle: "Ideation",
        ...
        questionnaireQuestionsBody: "The questions within the onboarding flow have been conceptualised by the product owner and serve a specific purpose: to gather data necessary for connecting students with study opportunities once the onboarding process is finished.",
        questionnaireQuestionsHeader: "Questions:",
        conceptTitle: "Design Concept",
        conceptColor: "var(--tertiary-yellow)",
        conceptBody: ""
    },
