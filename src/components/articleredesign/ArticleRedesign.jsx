            ...
            <section className="casestudy-section">
                <div className="casestudy-section_wrapper">
                    ...
                    <div className="article-section_title-wrapper">
                        ...
                        <p className="text-body-large">
                            <span className="article-section_span">{data.article.taxonomyBody5}</span>
                            <span className="article-section_span">{data.article.taxonomyBody6}</span>
                            <span className="article-section_span">{data.article.taxonomyBody7}</span>
                            <span className="article-section_span">{data.article.taxonomyBody8}</span>
                            <span className="article-section_span">{data.article.taxonomyBody9}</span>
                        </p>
                    </div>
                </div>
            </section >
